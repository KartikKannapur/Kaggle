...
print('load train...')
train_df = pd.read_csv('data/train.csv', nrows=100000, dtype=dtypes, usecols=['ip','app','device','os', 'channel', 'click_time', 'is_attributed'])
print('load test...')
...
print("writing...")
sub.to_csv('sub_lgb_balanced99_kartik_modifiedligthgbm.csv',index=False)
print("done...")
print(sub.info())